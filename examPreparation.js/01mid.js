function cookingMasterclass (data) {
    ...
    let additionalApronsCount = students * 0.2

    if (students % 5 === 0) {
        freePackages = students / 5 
    }

    let price = flourPrice * (students - freePackages) + apronPrice * (students + Math.ceil(additionalApronsCount)) + eggsPrice * students
